...
## Content license
By default, the posts are licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/),
...
### Assets license
The IOKode logo images and other assets are licensed under [IOKode IVAL license](/ival).