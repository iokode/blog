...
Writing the [OpinionatedFramework](https://iokode.blog/posts/este-framework-tiene-opinion/) posts, I noticed that I needed a way to link posts of the same series,
...
too, but while it can be deployed in a shared hosting, it's deployed in [CloudFlare Workers](https://workers.cloudflare.com), which has a
